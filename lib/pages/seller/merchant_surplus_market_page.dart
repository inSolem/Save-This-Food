...
class MerchantSurplusMarketPage extends StatelessWidget {
  const MerchantSurplusMarketPage({Key? key}) : super(key: key);
                  ...
                  builder: (context, state) {
                    if (state is ProductLoading) {
                      ...
                      List<Product> items = state.products
                          ...
                          .where((product) =>
                              product.businessName != "Newcastle United")
                          .toList();
                      if (items.isEmpty) {
                        return const Text(
