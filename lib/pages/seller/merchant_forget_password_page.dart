...
class MerchantForgetPasswordPage extends StatefulWidget {
  MerchantForgetPasswordPage({Key? key}) : super(key: key);

  @override
  State<MerchantForgetPasswordPage> createState() =>
      _MerchantForgetPasswordPageState();
}

class _MerchantForgetPasswordPageState
    extends State<MerchantForgetPasswordPage> {
